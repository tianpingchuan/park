...
<title>登录界面</title>
<link href="assert/login/css/default.css" rel="stylesheet" type="text/css" />
<!--必要样式-->
<link href="assert/login/css/styles.css" rel="stylesheet" type="text/css" />
<link href="assert/login/css/demo.css" rel="stylesheet" type="text/css" />
<link href="assert/login/css/loaders.css" rel="stylesheet" type="text/css" />
</head>
<body>
		...
		<div class='login'>
			...
			<div class='login_fields'>
				...
				<div class='login_fields__password'>
					...
					<input name="userPass" placeholder='密码' maxlength="16" type='text' autocomplete="off">
					<div class='validation'>
						<img alt="" src='assert/login/img/tick.png'>
					</div>
				</div>
				...
				<div class='login_title'>
					<div class='login_fields__password'>
						<div class='icon'>
							<input type="checkbox" class="checkbox" name="remember" value="1" lay-skin="primary"> <span>记住密码</span>
						</div>
					</div>
				</div>
				<div class='login_fields__submit'>
					<input type='button' lay-submit lay-filter="but_submit" value='登录'>
					<a href="loginin" type="button" class="layui-btn layui-btn-radius layui-btn-normal">注册</a>
				</div>
			</div>
		</div>
	</form>
	...
	<script type="text/javascript" src='assert/login/js/stopExecutionOnTimeout.js?t=1'></script>
